...
async def migrate_db():
    ...
    new_columns = [
        ...
        "CREATE TABLE IF NOT EXISTS push_subscriptions (id VARCHAR PRIMARY KEY, user_identifier VARCHAR NOT NULL, order_id VARCHAR NOT NULL REFERENCES orders(id), endpoint VARCHAR NOT NULL, p256dh VARCHAR NOT NULL, auth VARCHAR NOT NULL, language VARCHAR NOT NULL DEFAULT 'en', created_at DATETIME)",
        "ALTER TABLE push_subscriptions ADD COLUMN language VARCHAR NOT NULL DEFAULT 'en'",
    ]
    async with engine.begin() as conn:
